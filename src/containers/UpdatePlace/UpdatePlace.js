        ...
        <Row>
          <Col xs={12} lg={{offset:2, span: 8}}>
            <Form onSubmit={handleSubmit}>
              <h1 className="page__title text-center">Share with us your favourite place</h1>
              ...
              <Form.Group controlId="address">
                ...
                <Form.Control
                  ...
                  />
                <Form.Text className="text-muted">
                  There are different formats and that's OK but we recommend this format: 12 S Circular Rd, Portobello, Dublin 8, D08 XTN5
                </Form.Text>
              </Form.Group>
